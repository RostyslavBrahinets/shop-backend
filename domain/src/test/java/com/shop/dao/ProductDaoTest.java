...
public class ProductDaoTest {
    ...
    void product_by_barcode_was_not_found() {
        Optional<Product> product = productDao.findByBarcode("123");
    ...
    void product_not_deleted_in_case_when_not_exists() {
        assertThatCode(() -> productDao.delete("123")).doesNotThrowAnyException();
    }
    ...
    void save_image_for_product() {
        ...
        productDao.saveImageForProduct(new byte[]{127, 127, 127}, 1);
